...
class Game:
    def __init__(self):
        ...
        self.wood_amt = 150 # Displays amount of wood the player has.
    ...
    def build_single_home(self, money_label, wood_label):
        if self.wood_amt >= self.single_house_amt and self.money_amt >= self.single_house_cost:
            self.money_amt -= self.single_house_amt
...
class SingleHouse:
    def __init__(self, inhabitant_amount):  # Inhabitant amount should return an integer
